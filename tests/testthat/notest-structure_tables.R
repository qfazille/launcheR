...
test_that("getWaitBatch structure", {
    ...
    expect_equal(c("batchid", "queueid", "group", "path", "name", "parallelizable", "wait", "progress"), colnames(df))
    expect_equal(c("numeric", "numeric", "character", "character", "character", "logcial", "numeric", "numeric"), sapply(df, class))
})
